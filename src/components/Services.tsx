      ...
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 mb-12 md:mb-16 px-4">
          {services.map((service) => (
            <div 
              key={service.id} 
              className="bg-white rounded-xl p-6 md:p-8 border border-yellow-200 shadow-sm hover:shadow-md hover:border-yellow-300 transition-all duration-300 transform hover:scale-[1.02] animate-fade-in"
        ...
        {/* Basket Options */}
        <div className="mb-12 md:mb-16 animate-fade-in px-2 md:px-4" style={{ animationDelay: '0.4s' }}>
        ...
        <div className="mt-12 md:mt-16 text-center px-4">
          <a 
            href="#contact" 
            className="bg-red-600 hover:bg-red-700 text-white px-5 md:px-6 py-2.5 md:py-3 rounded-md transition-all flex items-center justify-center gap-2 font-medium inline-flex shadow-md hover:shadow-lg"
          >
